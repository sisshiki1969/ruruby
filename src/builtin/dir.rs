...
mod test {
    ...
    fn dir_test() {
        ...
        assert ["src/alloc.rs","src/builtin/array.rs","src/coroutine/asm_windows_x64.rs","src/coroutine/asm_x64.rs","src/coroutine/asm_arm64.rs","src/value/array.rs","src/vm/args.rs"].sort, Dir["src/**/a*s"].sort
